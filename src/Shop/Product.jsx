...
setMydata(data);
  ...
  return (
    ...
    <div >
    <h4 className='mt-4 cursor-pointer text-teal-700 font-extrabold'>Home</h4>
    </div>
...

{
    ...
    <img onClick={()=>navigation("/Recommended",{state:{have:id}})}  src={prod.murl.toString()} className='w-full h-4/4 rounded-tr-md rounded-tl-md' />
...
<div className='w-full flex-col justify-center overflow-y-auto no-scrollbar'>
